...
public @interface FromStringFactory {
    ...
    /**
     * The factory class containing the static method annotated with {@code @FromString}
     * The static method must have a return type of the type that declares this annotation.
     */
    Class<?> factory();
